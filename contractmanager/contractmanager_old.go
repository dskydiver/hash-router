...
// 						}
// 						go seller.watchHashrateContract(string(addr.Hex()), hrLogs, hrSub)
// 					}
// 				}
// 			}
// 		}
...
// 			seller.NodeOperator.Contracts[string(sellerContracts[i].Hex())] = msgbus.ContAvailableState

// 			if contractValues[i].State == RunningState {
// 				seller.NodeOperator.Contracts[string(sellerContracts[i].Hex())] = msgbus.ContRunningState
...
// 					seller.NodeOperator.Contracts[string(address.Hex())] = msgbus.ContAvailableState
...
// 			buyer.NodeOperator.Contracts[string(buyerContracts[i].Hex())] = msgbus.ContRunningState
...
// func (buyer *BuyerContractManager) closeOutMonitor(minerCh msgbus.EventChan, contractCh msgbus.EventChan, contractId string) {
// 	for {
// 		select {
// 		case <-buyer.Ctx.Done():
...
// // 		NodeOperator.Contracts[string(contractAddress.Hex())] = msgbus.ContAvailableState
