...
// func findSubsets(sortedMiners HashrateList, targetHashrate uint64, hashrateTolerance float64) (minerCombinations []HashrateList) {
...
// func sumSubsets(sortedMiners HashrateList, n int, targetHashrate uint64, hashrateTolerance float64) (m HashrateList, sum uint64) {
...
// func bestCombination(minerCombinations []HashrateList, targetHashrate int) (HashrateList, int) {
