...
// KEPT FOR REFERENCE TO PREV IMPLEMENTATION
...
// 	m, err := stratumv1_message.ParseMessageToPool(msg)
// 	if err != nil {
// 		s.log.Error(err)
// 		return msg
// 	}
...
// 	m, err := stratumv1_message.ParseMessageFromPool(msg)
// 	if err != nil {
...
// func (s *StratumV1) tryRunHandler(name HandlerName, msg stratumv1_message.MiningMessageGeneric) []byte {
