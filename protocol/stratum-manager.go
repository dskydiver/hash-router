...
// type StratumResultHandler = func(a stratumv1_message.MiningResult) stratumv1_message.MiningMessageGeneric
...
// 	isChangingPool bool
// 	subscribeMsg   stratumv1_message.MiningMessageToPool
// 	authUser       string
// 	authPass       string
// 	log            *zap.SugaredLogger

// 	notificationsOnHold           chan stratumv1_message.MiningMessageGeneric
// 	notificationsCh               chan stratumv1_message.MiningMessageGeneric
...
// 		authUser:                      authUser,
// 		authPass:                      authPass,
// 		notificationsOnHold:           make(chan stratumv1_message.MiningMessageGeneric, 100),
// 		notificationsCh:               make(chan stratumv1_message.MiningMessageGeneric, 100),
...
// 	m.handler.OnMinerRequest(func(msg stratumv1_message.MiningMessageToPool, s StratumHandlerObject) stratumv1_message.MiningMessageGeneric {
// 		_, ok := msg.(*stratumv1_message.MiningSubscribe)
// 		if ok {
// 			m.subscribeMsg = msg
// 		}

// 		authMsg, ok := msg.(*stratumv1_message.MiningAuthorize)
// 		if ok {
// 			authMsg.SetMinerID(m.authUser)
// 			authMsg.SetPassword(m.authPass)
// 		}

// 		submitMsg, ok := msg.(*stratumv1_message.MiningSubmit)
// 		if ok {
...
// 	m.handler.OnPoolResult(func(msg *stratumv1_message.MiningResult, s StratumHandlerObject) stratumv1_message.MiningMessageGeneric {
// 		if msg.IsError() {
...
// 				return nil
// 			}
// 			msg = m.(*stratumv1_message.MiningResult)
// 		}

// 		return msg
// 	})

// 	m.handler.OnPoolNotify(func(msg *stratumv1_message.MiningNotify, s StratumHandlerObject) stratumv1_message.MiningMessageGeneric {
// 		m.notificationsCh <- msg
// 		return nil
// 	})

// 	m.handler.OnPoolSetDifficulty(func(msg *stratumv1_message.MiningSetDifficulty, s StratumHandlerObject) stratumv1_message.MiningMessageGeneric {
// 		m.notificationsCh <- msg
// 		return nil
// 	})
// }
...
// 	authMsg := stratumv1_message.NewMiningAuthorize(1, username, password)
...
// func (m *StratumV1Manager) SendNotice(msg stratumv1_message.MiningMessageGeneric) error {
// 	return m.stratum.WriteToMiner(context.TODO(), msg.Serialize())
// }

// func (m *StratumV1Manager) SendPoolRequestWait(msg stratumv1_message.MiningMessageToPool) (*stratumv1_message.MiningResult, error) {
